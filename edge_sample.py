...
class BotDataset(Dataset):
    def __init__(self, name, batch_size, user_num):
        ...
        idx1 = torch.randperm(follower_edge.size(1))[0 : int(ratio * follower_edge.size(1))].tolist()
        idx2 = torch.randperm(following_edge.size(1))[0 : int(ratio * following_edge.size(1))].tolist()

        self.edge_index_list = [follower_edge[:, idx1], following_edge[:, idx2]]
        ##########################################################
